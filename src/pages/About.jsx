        ...
        <div>
            ...
            <div className=' flex flex-col md:flex-row justify-center gap-12 my-10 flex-wrap items-center'>
                ...
                <div className='justify-center  flex flex-col gap-3 items-center flex-1 md:w-2/4 md:min-w-72 text-sm text-gray-600'>
                    <p>Welcome to Health Horizon, your trusted partner in managing your healthcare needs conveniently and efficiently. At Health Horizon, we understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records</p>
                    <p>Health Horizon is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether you're booking your first appointment or managing ongoing care, Health Horizon is here to support you every step of the way.

                    </p>
                    <b className='text-gray-800'>Our Vision</b>
                    <p>Our vision at Health Horizon is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.</p>
                </div>
            </div>
